...
<?php 
	...
	<div class="row">
		<ol class="breadcrumb">
		  ...
		  <li class="active">Avance Seats bookings by movie</li>
		</ol>
	</div><!--row-->
...
<form class="form-horizontal dashboardForm"  action="" method="post">
			...
			<div class="table-responsive">
			  <?php
				...
				<thead>
					...
					<tr> 
					<th style=" font-size: 14px;"><strong>Report Day : </strong><strong><?php echo  $s_date; ?></strong></th>
	...
	<tr> 
					<th colspan="3" style="text-align:center;"><strong><?php $all_movie = $movie->get_movies($m_id);
	...
	<tr> 
		...
		<th style="text-align:center;"><strong>Report Day : </strong><strong><?php echo  $s_date; ?></strong></th>
	    <th style="text-align:center;"></th>
		<th style="text-align:center;"><strong> Current time : </strong><strong><?php echo $current_date_time; ?></strong></th>
