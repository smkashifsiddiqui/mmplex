...
<form class="form-horizontal dashboardForm"  action="" method="post">
	...
	<div class="col-md-6">
			...
			$results = $reports->get_package_sales_by_user($r_start_date, $user_id);
				}
			?>		
...
<tr> 
					<th colspan='5'  style="text-align:center;"><strong>Package Sale by User</strong></th>
					</tr> 					
					
					<tr> 
					<th colspan='3'  style="text-align:center;" ><strong>Report date : </strong><strong><?php echo $r_start_date1; ?></strong></th>
