		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-header-inner">
					...
					<a class="pull-right add-button"  href="add_ticket.php">Add Ticket </a>
				</div>
			</div><!--col-md-12-->
		</div><!--row-->
			...
			<div class="col-md-12">	
				...
				<table border="1" cellpadding="0" cellspacing="0" id="example" class="table table-hover tableView admin-table">
					...
					<tbody class="searchable">
						...
						echo '<tr>';
						echo '<td>'. $res->ticket_title .'</td>';
						echo '<td>'. $res->ticket_type .'</td>';
						echo '<td>'. $res->ticket_status .'</td>';
						echo '<td class="alignCenter"><a class="edit_btn" href="add_ticket.php?id='.$res->ticket_id.'">Edit</a></td>';
						echo '<td class="alignCenter"><input type="hidden" class="id_to_delete" value="'.$res->ticket_id.'"><a href="#" data-toggle="modal" data-target=".delete_confirm_modal"><img class="img_delete" src="assets/images/delete_icon.png"/></a></td>';
						echo '</tr>';
						}
						?>
						</tbody>
