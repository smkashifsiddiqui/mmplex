...
public function get_concession_items()
	...
	public function concession_booking($order_id,$con_booking_type_id, $con_booking_type, $con_booking_price, $con_booking_qty)
	{
	...
	public function delete_concession($id,$select_per)
	{
		$data = array();
