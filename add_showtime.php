...
<form class="form-horizontal dashboardForm"  action="" method="post" enctype="multipart/form-data">
		<div class="row gray-header">
					...
					<div class="form-header-inner">
						<div class="col-sm-6">
				 		...
				 		<div class="col-sm-6 action_btn">
					 		...
					 		<button type="submit" class="btn submitBtn save-button" id="add_showtime" name="add_showtime"><?php echo (isset($_GET['id']))? 'Save Changes ' : 'Add Show time' ?>  </button>
			...
			if (isset($_POST['add_showtime'])) {		
				...
				if (isset($ID)) {
					...
					$results = $showtime->insert_showtime($_POST);
				}
				if ($results) {
	...
	<div class="col-md-6">
			...
			<div class="col-md-11 col-md-offset-1">	
				...
				<input type="hidden" name="show_time_if_update" id="" value="<?php echo (isset($ID))? $ID : '' ?>" class="form-control "  >
			...
			<button type="button" style="padding: 4px 10px;background-color: #8D5963;" class="btn submitBtn save-button  delete_clone" class="btn submitBtn save-button " value="">Delete</button>
				...
				<div class="col-md-12 inner_clone_div_parent" style="padding:0px;">
					...
					<div class="col-md-6 date_label" style="margin-right: -110px;padding-top: 10px;border-top: 1px solid #ccc;padding-top: 10px;">	
							...
							<label for="showtime_datetime" class="col-sm-3 control-label"><span>* </span>Show Date</label>
							<div class="col-sm-8">
					...
					<div class="col-md-6">
					<div id="time_confilict" class="time_confilict alert alert-danger" role="alert" style="display:none;padding: 10px;margin-bottom: 5px;"> Date Time can confilict! </div>
					</div>
