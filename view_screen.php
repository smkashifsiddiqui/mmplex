		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="alert alert-danger" role="alert" style="display:none;">Screen has assigned showtimes! </div>
					<a class="pull-right add-button" href="add_screen.php">Add Screen </a>
				</div>
			</div><!--col-md-12-->
		</div><!--row-->
			...
			<div class="col-md-12">	
				...
				<table border="1" cellpadding="0" cellspacing="0" id="example" class="table table-hover tableView admin-table">
					...
					<tbody class="searchable">
						...
						echo '<td>'. $res->screen_total_seats .'</td>';
						echo '<td class="alignCenter"><a class="edit_btn" href="add_screen.php?id='.$res->screen_id.'">Edit Screen</a></td>';
						echo '<td class="alignCenter"><input type="hidden" class="id_to_delete" value="'.$res->screen_id.'"><a href="#" data-toggle="modal" data-target=".delete_confirm_modal"><img class="img_delete" src="assets/images/delete_icon.png"/></a></td>';
						echo '</tr>';
						}
						?>
					</tbody>
