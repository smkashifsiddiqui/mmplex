	  ...
	  <div class="row">
		...
		<div class="row">
			...
			<div class="col-md-12">	
				...
				$results = $distributer->get_distributers();
				if ($results) {
				?>
				<table border="1" id="example" cellpadding="0" cellspacing="0" class="table table-hover tableView admin-table">
					...
					<tbody class="searchable">
						...
						echo '<td>'. $res->dist_description .'</td>';

						echo '<td class="alignCenter"><a class="edit_btn" href="add_distributer.php?id='.$res->dist_id.'">Edit</a></td>';
						echo '<td class="alignCenter"><input type="hidden" class="id_to_delete" value="'.$res->dist_id.'"><a href="#" data-toggle="modal" data-target=".delete_confirm_modal"><img class="img_delete" src="assets/images/delete_icon.png"/></a></td>';
						echo '</tr>';
						}
						?>
						</tbody>
