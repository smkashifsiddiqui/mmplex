...
links.Timeline = function(container, options) {
    ...
    this.options = {
        ...
        'showCurrentTime': true, // show a red bar displaying the 
...
/**
 * Adjust the visible range such that the  is located in the center
 * of the timeline
 */
...
links.Timeline.prototype.repaintCurrentTime = function() {
    ...
    dom.currentTime.title = ": " + nowOffset;
...
/**
 * Set . This function can be used to set the time in the client
...
/**
 * Get . The time can have an offset from the real time, when
 * the  has been changed via the method setCurrentTime.
 * @return {Date} time
 */
...
links.Timeline.StepDate.prototype.next = function() {
    ...
    // safety mechanism: if  is still unchanged, move to the end
 ...
 * date and the scale. For example when scale is MINUTE, the  is
 * formatted as "hh:mm".
