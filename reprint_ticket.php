...
$booking_result =  $booking->get_booked_tic($_GET['id']);
	 ...
	 <div class="" style="width: 20%;float: left;">
		...
		<table>
			...
			<tr>
				...
				<td><strong style="font-size:11px;padding-left: 10px;"><?php echo $unique_id; ?></strong></td>
			</tr>
			...
			<tr>
				...
				<td><span style="font-size:12px;padding-left: 10px;"><?php echo $booking_result->booking_showdate; ?></span></td>
			</tr>
			...
			<tr>
				...
				<td><span style="font-size:12px;padding-left: 10px;"><?php echo date('h:i', strtotime($booking_result->booking_showtime)); ?></span></td>
			</tr>
			...
			<tr>
				...
				<td><span style="font-size:12px;padding-left: 10px;font-weight:bold;"><?php echo $booking_result->screen_name; ?></span></td>
			</tr>
			...
			<tr>
				...
				<td><span style="font-size:13px;padding-left: 10px;font-weight:bold;text-transform:uppercase;"><?php echo $booking_result->booking_seats_number; ?></span></td>
			</tr>
			...
			<tr>
				...
				<td><span style="font-size:12px;padding-left: 10px;"><?php echo $booking_result->movie_title; ?></span></td>
			</tr>
			...
			<tr>
				...
				<td><span style="font-size:12px;padding-left: 10px;"><?php echo $booking_result->booking_price; ?></span></td>
			</tr>
