    ...
    // Create some JSON data
     ...
     <?php foreach($all_showtime as $res) {
        ...
        ?>
        {
            ...
            'content': '<a href="add_showtime.php?id=<?php echo $res->showtime_id?>"><?php echo $res->movie_title; ?> ( <?php echo $res->movie_duration; ?> min)<p class="film_small_desc"> Start Time: <?php echo $start_label; ?> End Time: <?php echo $end_label; ?></p></a>',
            'editable': false,
...
<script>
        ...
        div.className = 'col-md-12 row-el';
        div.innerHTML = '<div class="form-group">\
                            <label for="showtime_datetime" class="col-sm-4 control-label"><span>* </span>Show Date & Timings: </label>\
                                <div class="col-sm-8 show" style="position:relative;">\
                                    <input type="text" name="showtime_datetime[]" id="showtime_datetime'+len+'" value="" class="checktime form-control" placeholder="Insert date time" required>\
        ...
        // Minus Button function for Offer Page
            $("#content1").on('click', '.minus-btn', function() {
                ...
                $(this).parent('.show').parent('.form-group').parent('.row-el').remove();
