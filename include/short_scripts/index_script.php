<?php $all_showtime = $showtime->get_all_showtimes(); 
...
<script type="text/javascript" src="assets/js/timeline.js"></script>	
    ...
    // Create some JSON data
     ...
     <?php foreach($all_showtime as $res) {
        ...
        $total_time = $cleanup_time + $trailer_time + $movie_time;
        ...
        ?>
        {
            ...
            'content': '<?php if($showtime_key == "private"){?> <a href="add_private_showtime.php?id=<?php }else{?><a href="add_showtime.php?id=<?php }?><?php echo $res->showtime_id?>"><?php echo $res->movie_title; ?><p class="film_small_desc"> Start Time: <?php echo $start_label; ?> End Time: <?php echo $end_label; ?></p></a>',
            'editable': false,
