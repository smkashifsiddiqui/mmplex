				...
				<div class="col-md-6 nopadding" id="content1">
						...
						<div class="col-md-12 row-el">	
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" name="<?php if((isset($ID))){ echo 'showtime_datetime';}else {echo 'showtime_datetime[]';} ?>" id="showtime_datetime" value="<?php echo (isset($ID))? $showtime_result->showtime_datetime : '' ?>" class="checktime form-control " placeholder="Insert date time" required>
								</div>
							</div>
							<div class="clear"></div>
						</div>
